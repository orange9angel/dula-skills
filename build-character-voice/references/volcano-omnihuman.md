...
3d. **prompt 不得提及底图中不存在的事物**（E07 实测）：写了"视线落在猫
   身上"而底图无猫，模型在画面角落脑补出一条狐狸尾。omni prompt 里的
   视线/互动对象必须在底图里真实存在。
3e. **敬畏≠神秘**（E07 V3 导演定调）：科幻暗线镜头要"高阶智能降临"的
   干净敬畏感——prompt 写"眼神清亮笃定、像讲述美好事物、毫无阴霾"，
   不要写"神秘/眉头微蹙/悠远"（会出鬼片感）。
